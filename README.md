...
ReactとTailwind CSSを使用し、藍色・生成り・墨色を基調とした「和モダン × ミニマル」なデザインで構築しています。初期HTMLはビルド時に生成し、ブラウザではモバイルメニューとCMS公開データの自動同期を実行します。
...
- 小金井キャンパスの部室案内図
- 年度別の大会結果表示
- CMSのお知らせ・大会記録を初回表示時と30秒ごとに自動同期
- CMS障害時はプリレンダリング済みの静的データを表示
...
# 最後に
こんにちは、このページの作者の友兼です。
本ホームページは2026年07月に作成されました。このページが幾年にもわたって維持、更新されていくことを期待しています。将来の将棋部の皆さん。私の知る世代かどうかはわかりませんが、皆さんの成功を心からお祈りしています。<br>
友兼隆斗より
<br><br>

友兼隆斗の略歴<br>
2026年4月東京農工大学知能情報システム工学科入学<br>
同年　同大学将棋部入部<br>
